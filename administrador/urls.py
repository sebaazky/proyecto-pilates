...
URLs del panel CMS personalizado para el cliente administrador.
"""
...
urlpatterns = [
    ...
    path('blog/<int:pk>/eliminar/', views.blog_eliminar, name='blog_eliminar'),
    path('blog/<int:pk>/toggle/', views.blog_toggle_publicado, name='blog_toggle'),
